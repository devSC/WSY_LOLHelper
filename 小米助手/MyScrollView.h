...
//声明Block来传值
@property (nonatomic, copy) voidBlock_string myBlock;
@property (nonatomic, retain) MyScrollViewButton *imageButton;
 ...
 *自动轮播的图片数组(来自于网络)
 *------------------------------------------------------*/
@property (nonatomic, retain)NSArray *urlStringArray;
